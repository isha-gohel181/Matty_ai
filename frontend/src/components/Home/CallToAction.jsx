      ...
      <div className="mx-auto max-w-7xl px-4 text-center">
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground font-display uppercase tracking-wider">
              Ready to Unlock Premium Features?
            </h2>
            <p className="mt-4 text-base sm:text-lg text-secondary-text mb-8 font-editorial leading-relaxed max-w-xl mx-auto">
              Get unlimited AI suggestions, access all templates, and more with our Pro plans.
            </p>
            <Button 
              size="lg" 
              className="mt-8 rounded-full px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg bg-primary hover:bg-primary/90 text-primary-foreground font-utility uppercase tracking-widest text-xs"
