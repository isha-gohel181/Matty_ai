...
const TestimonialsSection = () => {
    return (
        <section id="testimonials" className="py-20 sm:py-32 bg-[#1a1a1a]">
            <div className="mx-auto max-w-screen-xl px-4">
                <h2 className="text-center text-4xl font-bold">Loved by Creators Worldwide</h2>
                <p className="text-center mt-4 text-gray-400">See what our users are saying about Matty.</p>
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <motion.div
                            ...
                            className="rounded-xl border border-white/10 bg-white/5 p-8 flex flex-col"
                        >
